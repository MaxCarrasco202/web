...
if(!empty($_SESSION['cart'])){
		foreach($_POST['remove_code'] as $key){
			...
			echo "<script>alert('Su carrito se ha actualizado exitosamente');</script>";
	}
}
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" alt="" width="150" height="100">
						</a>
					</td>
