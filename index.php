...
<head>
	...
	<title>GameTech Abancay - Pagina principal</title>
		...
		<div class="container">
			<div class="furniture-container homepage-container">
					...
					<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
						...
						<div id="hero" class="homepage-slider3">
							<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
								...
								<div class="full-width-slider">
									<div class="item full-width-slider" style="background-image: url(assets/images/sliders/slider22.png);">
									</div><!-- /.item -->
								</div><!-- /.full-width-slider -->
								...
								<div class="row">
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">Garantia de 10 meses.</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="hidden-md col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">tus pedidos mayores a s/.9000 tienen envío gratis</h6>
										</div>
									</div><!-- .col -->
									...
									<div class="col-md-6 col-sm-4 col-lg-4">
										<div class="info-box">
											...
											<h6 class="text">Todos los productos con descuento </h6>
										</div>
									</div><!-- .col -->
								</div><!-- /.row -->
					...
					<div class="row">
						<div class="col-md-6">
							<section class="section">
								<h3 class="section-title">laptops gamer</h3>
				...
				<section class="section featured-product inner-xs wow fadeInUp">
					<h3 class="section-title">Laptops escritorio</h3>
